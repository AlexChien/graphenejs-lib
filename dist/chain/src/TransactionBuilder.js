...
var _require3 = require('graphenejs-ws');

var Apis = _require3.Apis;
var ChainConfig = _require3.ChainConfig;
        ...
        */
        ...
        value: function set_required_fees(asset_id) {
            ...
            return Promise.all(promises).then(function (results) {
                ...
                var fees = _results[0];
                var coreFees = _results[1];
                var asset = _results[2];
        ...
        key: "sign",
        value: function sign() {
            var chain_id = arguments.length <= 0 || arguments[0] === undefined ? Apis.instance().chain_id : arguments[0];
