...
var account_balance_migrate_operation_fee_parameters = new Serializer(
    "account_balance_migrate_operation_fee_parameters",
    {fee: int64}
)
...
var account_balance_migrate = new Serializer(
    "account_balance_migrate",
    {fee: asset,
    account: protocol_id_type("account"),
    eth_address: string,
    extensions: set(future_extensions)}
